...
void printValue(pair<bool, int> &val)
{
    if (val.first == INT) {
        std::cout << (int)val.second << '#';
    } else
        std::cout << (char)val.second;
}
